...
import type { BillPeople, SaleBillHeader } from "@/features/sales/testbill/types";
...
export { BillCreditPanel, BillFactsLine } from "@/features/sales/testbill/components/credit-panel";
// ---------------------------------------------------------------------------
// Customer
// ---------------------------------------------------------------------------
