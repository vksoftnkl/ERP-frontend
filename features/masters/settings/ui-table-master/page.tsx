...
/**
 * The Grid Master row this list reads — "MAIN LIST - UI TABLES". `CrudMasterPage`
 * resolves it to a grid id at runtime (see lib/configured-grids), and uses it
 * for both the rows and the configured columns.
 */
const LIST_GRID_KEY = "uiTableMasterList" satisfies ConfiguredGridKey;
const API_ENDPOINTS = {
...
export default function UiTableMasterPage() {
  ...
  // can see soft-deleted UI tables. Lives beside the list search input.
  ...
  // this screen's grid SQL; keys with no matching token are ignored. `wantdelete`
  // is driven by the "Show deleted records" checkbox beside the list search input.
