...
const WIDGET_SECTION_MENU_ID = 27;
...
// (spg_* keys, matched case-insensitively). Form fields with no mapping — or no
// matching response entry — keep their hardcoded label and render after all
// configured fields.
const WIDGET_FIELD_NAME_BY_FORM_FIELD: Record<string, string> = {
  spgName: "spg_group_name",
  spgShort: "spg_short_name",
  spgDesc: "spg_description",
};
...
export default function SupplierGroupsPage() {
  ...
  // grid 18's stored SQL; keys with no matching token are ignored. `wantdelete` is
