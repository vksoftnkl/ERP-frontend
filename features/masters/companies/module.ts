...
export const companiesModule = defineMasterModule({
  title: "Company",
  entityLabel: "company",
  ...
  mapFormValues: ({ source, defaults }) => {
    ...
    return {
      ...
      masterShortName:
        toDisplayValue(getFirstDefinedValue(rowSource, LOOKUP_KEYS.short)) || mergedDefaults.masterShortName,
      compLegalName:
        toDisplayValue(getFirstDefinedValue(rowSource, COMPANY_LEGAL_NAME_KEYS)) || mergedDefaults.compLegalName,
      compStateCode:
        toDisplayValue(getFirstDefinedValue(rowSource, COMPANY_STATE_CODE_KEYS)) || mergedDefaults.compStateCode,
      position:
      ...
      masterDescription:
        toDisplayValue(getFirstDefinedValue(rowSource, LOOKUP_KEYS.description)) || mergedDefaults.masterDescription,
    };
  },
