...
function ModalFooterShortcuts({
  ...
  return (
    <div className={styles.footerShortcutList} aria-label="Keyboard shortcuts">
      ...
      {/* <span className={styles.footerShortcutTitle}>Shortcuts:</span> */}
        ...
        return (
          <Fragment key={shortcutKey}>
            ...
            <span className={styles.footerShortcutItem}>
              ...
              />
              {shortcut.label ? (
                <span className={styles.footerShortcutAction}>
                  {shortcut.label}
                </span>
              ) : null}
            </span>
...
function ModalFooterCancelIcon() {
  return (
...
function ModalFooterSubmitIcon({ label }: { label: string }) {
